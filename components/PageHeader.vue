<template>
    <div>
      ...
      <nav class="fixed w-full z-50 top-0 left-0 bg-transparent text-white transition-all duration-300">
              ...
              <li v-for="item in pagesLinks" :key="item.link">
                <NuxtLink
                  ...
                  :class="[
                    ...
                    activeLink === item.title ? 'text-black active-link' : 'text-white'
                  ]"
  ...
  <style scoped>
  body {
    margin-top: 80px; /* Navbar height adjustment */
  }
  .active-link {
    font-weight: bold;
  }
